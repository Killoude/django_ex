...
class QuestionModelsTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        old_question = Question(pub_time=time)
    ...
    def create_question(question_text, days):
        ...
        return Question.object.create(question_text=question_text, pub_time= time)
...
class QuestionIndexViewTests(Testcase):
    ...
    def test_future_question_and_past_question(self):
        """
        even if both past and future questions exists, ony past quesions are displayed
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_question(self):
        """
        The question index page may display multuple questions.
        """
        create_question(question_text="Past question 1.")
        create_question(question_text="Past question 2.")
        response = self.client.get(reverse('polls:index'))
        self.assertQuerySetEqual(response.context['latest_question_list'],['<Question: Past question 2.>','<Question: Past questions 1.>'])
